<?php
require 'config.php';
session_start(); // Certifique-se de que session_start() está sendo chamado no início
$_SESSION["id"] = 1;
        ...
        <div class="profile-content">
            <div class="left-column">
                <div class="field">
                    ...
                    <h2>Sobre você</h2>
                    <p class="user-bio">Campo de informação do usuário. Aqui você pode adicionar algumas informações sobre o usuário, seus interesses, hobbies, etc.</p>
                </div>
            </div>
            <div class="right-column">
                <div class="field">
                    ...
                    <ul class="fieldInf">
                        <li><strong>Nome:</strong> Maxsuel kaue</li>
